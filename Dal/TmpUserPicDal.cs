...
namespace Dal
{
    ...
    public class TmpUserPicDal
    {
        ...
        {
            string sql = string.Format(@"select * from TmpUserPic where pin in ({0});", Tools.UnionString(pins));
        ...
        {
            string sql = string.Format(@"select count(*) from TmpUserPic where pin='{0}' ", pin.ToLower());
...
");
        ...
        {
            string sql = string.Format(@"delete from TmpUserPic  where Pin in ({0});", Tools.UnionString(pins));
