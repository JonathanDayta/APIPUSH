...
namespace Dal
{
    ...
    public class TmpFveinDal
    {
        ...
        {
            string sql = string.Format(@"select * from TmpFvein where pin in ({0}) and ver='{1}';", Tools.UnionString(pins), ver);
        ...
        {
            string sql = string.Format(@"select count(*) from TmpFvein where pin='{0}' and ver='{1}'", pin.ToLower(), ver.ToLower());
...
");
            ...
            SqlParameter[] parameters = {
                        ...
                        new SqlParameter("@Ver", model.Ver),
        ...
        {
            string sql = string.Format(@"delete from TmpFvein  where Pin in ({0});", Tools.UnionString(pins));
